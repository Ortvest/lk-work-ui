...
import { useLazySearchWorkAssetsQuery } from '@global/api/workAssets/workAssets';

export const FindAssetField = (): React.ReactNode => {
  const { t } = useTranslation(['work-assets-table', 'employees-table']);

  const [triggerSearch] = useLazySearchWorkAssetsQuery();
